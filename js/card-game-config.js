...
window.App.pages.cardGame.CONST = {
    ...
    SKILLS: {
        ...
        'min': { name: '谦卑', short: '0', desc: '比点大小时视为 0', type: 'value' },
        'max': { name: '英雄', short: '8', desc: '比点大小时视为 8', type: 'value' },
    ...
    ENEMIES: [
        { name: '绿毛虫', icon: 'bug', color: 'text-green-500', bg: 'bg-green-100' },
        { name: '小拉达', icon: 'rat', color: 'text-purple-500', bg: 'bg-purple-100' },
        { name: '波波', icon: 'bird', color: 'text-amber-600', bg: 'bg-amber-100' },
        { name: '皮皮', icon: 'moon', color: 'text-pink-400', bg: 'bg-pink-100' },
        { name: '喵喵', icon: 'cat', color: 'text-yellow-600', bg: 'bg-yellow-100' },
        { name: '鲤鱼王', icon: 'fish', color: 'text-red-500', bg: 'bg-red-100' },
        { name: '卡比兽', icon: 'bed', color: 'text-blue-800', bg: 'bg-blue-100' },
        { name: '耿鬼', icon: 'ghost', color: 'text-purple-700', bg: 'bg-purple-200' },
        { name: '超梦', icon: 'zap', color: 'text-fuchsia-600', bg: 'bg-fuchsia-100' },
    ]
};
